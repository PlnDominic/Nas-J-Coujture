/**
 * Editorial photography for the homepage, used until real Nasji Culture
 * lookbook and product photos are uploaded via the admin panel. These are
...
export const categoryTileImages = {
  ...
  accessories: "/images/kaftan-black-agbada.jpg",
};

export const newSeasonImage = "/images/kaftan-black-agbada.jpg";
